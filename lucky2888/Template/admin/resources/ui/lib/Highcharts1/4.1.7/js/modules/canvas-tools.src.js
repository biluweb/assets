 ...
 * @link   //www.phpied.com/rgb-color-parser-in-javascript/
 ...
 *
 * Requires: rgbcolor.js - //www.phpied.com/rgb-color-parser-in-javascript/
 *
 */
if(!window.console) {
	window.console = {};
	...
	function build() {
		...
		svg.BoundingBox = function(x1, y1, x2, y2) { // pass in initial points if you want
			...
			this.addBezierCurve = function(p0x, p0y, p1x, p1y, p2x, p2y, p3x, p3y) {
				// from //blog.hackers-cafe.net/2009/06/how-to-calculate-bezier-curves-bounding.html
		...
		svg.AspectRatio = function(ctx, aspectRatio, width, desiredWidth, height, desiredHeight, minX, minY, refX, refY) {
			// aspect ratio - //www.w3.org/TR/SVG/coords.html#PreserveAspectRatioAttribute
		...
		svg.Element.path = function(node) {
			...
			// TODO: convert to real lexer based on //www.w3.org/TR/SVG11/paths.html#PathDataBNF
				...
				while (!pp.isEnd()) {
					...
					case 'A':
						while (!pp.isCommandOrEnd()) {
							...
							// //www.w3.org/TR/SVG11/implnote.html#ArcImplementationNotes
							// x1', y1'
...
(function (Highcharts) { // encapsulate
	...
	extend(CanVGRenderer.prototype, {
		 ...
		 * see: //code.google.com/p/canvg/issues/detail?id=104
		 *
