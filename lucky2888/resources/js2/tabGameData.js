...
var zhengh_title_arr = ['前/中/后三球','龙虎'];
...
var pks_lmp_title_arr = ['一、二、三、四、五名','六、七、八、九、十名'];
var pks_lmp_lmp1 = {
    '冠军':{
        '大':'lmp_d1m_da',
        '小':'lmp_d1m_xiao',
...
var pks_gyh_title_arr = ['冠亚和'];

var pks_yzwm_title = ['一至五名'];
var pks_lzsm_title = ['六至十名'];
