...
var userbindrealname = function(){
	...
	tiphtml += '<li><label class="ui-label">资金密码：</label><input class="input-text inline box-shadow radius size-L" type="password" id="bindrealname_tradepassword" way-data="bindrealname.tradepassword"></li>';
	tiphtml += '</ul>';
	tiphtml += '</div>';
...
var usereditdrawpass = function(){
	...
	tiphtml += '<li><label class="ui-label">旧资金密码：</label><input class="input-text inline box-shadow radius size-L" type="password" id="usereditdrawpass_oldpassword" way-data="usereditdrawpass.oldpassword"></li>';
	tiphtml += '<li><label class="ui-label">新资金密码：</label><input class="input-text inline box-shadow radius size-L" type="password" id="usereditdrawpass_password" way-data="usereditdrawpass.password"></li>';
